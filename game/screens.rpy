...
screen characterProfile(character):
    $ A = 1

## Player profile screen ######

screen playerProfile(player):
    if player.sex == "m":
        $ A = 1
    elif player.sex == "f":
        $ A = 2
    ...
    frame:
        ...
        hbox:
            if creation_points == 0:
                ...
                textbutton ("Strength") xminimum 200 action [SetVariable("skill1_points", skill1_points + 1), SetVariable("creation_points", creation_points - 1)]
            bar range skill1_max value skill1_points xmaximum 200
        hbox:
            if creation_points == 0:
                textbutton ("Fitness") xminimum 200 action None
            else:
                textbutton ("Fitness") xminimum 200 action [SetVariable("skill2_points", skill2_points + 1), SetVariable("creation_points", creation_points - 1)]
            bar range skill2_max value skill2_points xmaximum 200
        hbox:
            if creation_points == 0:
                textbutton ("Endurance") xminimum 200 action None
            else:
                textbutton ("Endurance") xminimum 200 action [SetVariable("skill2_points", skill2_points + 1), SetVariable("creation_points", creation_points - 1)]
            bar range skill2_max value skill2_points xmaximum 200
        hbox:
            if creation_points == 0:
                textbutton ("Charisma") xminimum 200 action None
            else:
                textbutton ("Charisma") xminimum 200 action [SetVariable("skill2_points", skill2_points + 1), SetVariable("creation_points", creation_points - 1)]
            bar range skill2_max value skill2_points xmaximum 200
        hbox:
            if creation_points == 0:
                textbutton ("Sexperience") xminimum 200 action None
            else:
                textbutton ("Sexperience") xminimum 200 action [SetVariable("skill2_points", skill2_points + 1), SetVariable("creation_points", creation_points - 1)]
            bar range skill2_max value skill2_points xmaximum 200
        hbox:
